...
#SBATCH --output=segger_experiments.out    # Output file (%j will be replaced with the job ID)
...
python train_segger_experiments.py \
  ...
  --output_dir data/peer/riffled/segger/development_tools/segger_experiments/bce_true_triplet_false_enrich_global_edges_false_global_gene_cov_weight_1.0
...
python train_segger_experiments.py \
  ...
  --global_gene_cov_weight 1.0 \
  --output_dir data/peer/riffled/segger/development_tools/segger_experiments/bce_true_triplet_false_enrich_global_edges_true_global_gene_cov_weight_1.0
...
python train_segger_experiments.py \
  ...
  --enrich_global_edges=True \
  --global_gene_cov_weight 1.0 \
  --output_dir data/peer/riffled/segger/development_tools/segger_experiments/bce_false_triplet_false_enrich_global_edges_true_global_gene_cov_weight_1.0
...
python train_segger_experiments.py \
  ...
  --enrich_global_edges=False \
  --global_gene_cov_weight 1.0 \
  --output_dir data/peer/riffled/segger/development_tools/segger_experiments/bce_false_triplet_false_enrich_global_edges_false_global_gene_cov_weight_1.0